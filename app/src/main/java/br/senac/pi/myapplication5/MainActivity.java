package br.senac.pi.myapplication5;
    ...
    private View.OnClickListener calcular() {
        return new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                double calcular = Peso / x;
                TextView text=(TextView)findViewById(R.id.txtResultado);
                text.setText(getString(R.string.resultado)+ calcular);
                //Toast.makeText(MainActivity.this, getString(R.string.resultado) + calcular, Toast.LENGTH_SHORT).show();
